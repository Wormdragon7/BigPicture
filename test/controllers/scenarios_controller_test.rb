...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post scenarios_url, params: { scenario: { description: @scenario.description, end: @scenario.end, image: @scenario.image, start: @scenario.start, title: @scenario.title } }
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { description: @scenario.description, end: @scenario.end, image: @scenario.image, start: @scenario.start, title: @scenario.title } }
